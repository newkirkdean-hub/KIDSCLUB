 ...
 * @author Dean
 */
public class QTYEMPTouchScreenLoginController implements Initializable {
    @FXML private Button cancelButton;
    @FXML private Button selectButton;
    @FXML private Button removeButton;
    @FXML private TextField passWordTextfield;
    @FXML private Pane root;
    @FXML public static String tString, ctString;
    @FXML public static boolean remove, removeButtonTF;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Platform.runLater(()->setTitleString(tString));
        Platform.runLater(()->setColumnTitleString(ctString));
    ...
    public void setTitleString(String string) {
        System.out.println("This is tString: " + string);
        this.tString = string;
        textLabel.setText(tString);
        if(!removeButtonTF) {
    ...
    public void setColumnTitleString(String string) {
        System.out.println("This is ctString: " + string);
