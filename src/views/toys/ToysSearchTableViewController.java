 ...
 * @author Dean
 */
public class ToysSearchTableViewController implements Initializable {
    @FXML private TableView<Toys> gamesTable;
    @FXML private TableColumn<Toys, String> gameNameColumn;
    @FXML private TableColumn<Toys, String> gameLocationColumn;
    @FXML private TableColumn<Toys, String> gameTicketsColumn;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            gamesTable.getItems().addAll(TDB.GetToys());
...
//        FilteredList<Member> filterData = new FilteredList<>(getGames(), p -> true);
        FilteredList<Toys> filterData = new FilteredList<>(gamesTable.getItems(), p -> true);
        searchField.textProperty().addListener((obsevable, oldvalue, newvalue) -> {
            ...
            SortedList<Toys> sortedList = new SortedList<>(filterData);
